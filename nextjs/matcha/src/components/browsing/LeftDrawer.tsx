		...
		<div className="w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col h-screen">
			...
			<div className="flex border-b border-gray-200 dark:border-gray-700">
				<button
					...
					className={`flex-1 py-3 text-center font-medium transition-colors ${activeTab === "matches"
				...
				<button
					...
					className={`flex-1 py-3 text-center font-medium transition-colors ${activeTab === "messages"
						? "text-indigo-600 dark:text-indigo-400 border-b-2 border-indigo-600 dark:border-indigo-400"
						: "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"
						}`}
				>
					...
					<div className="p-2">
						{matches.length === 0 ? (
							<div className="text-center py-8">
								<Typography color="secondary">Aucun match pour le moment</Typography>
							</div>
						) : (
							matches.map((match) => (
								<MatchCard
