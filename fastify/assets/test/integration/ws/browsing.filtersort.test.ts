...
const setTags = async (app: FastifyInstance, token: string, tags: Array<string>) => {
    await app.inject({
        method: 'PUT',
...
const viewUser = async (app: FastifyInstance, token: string, likedUserId: number) => {
    await app.inject({
        method: 'GET',
...
const likeUser = async (app: FastifyInstance, token: string, likedUserId: number) => {
    await app.inject({
        method: 'POST',
